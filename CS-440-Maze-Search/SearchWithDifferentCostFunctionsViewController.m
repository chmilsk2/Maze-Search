//
//  SearchWithDifferentCostFunctionsViewController.m
//  CS-440-Maze-Search
//
...
#define TAB_TITLE @"1.2"
#define MAZE_PARSING_NOTIFICATION_NAME @"MazeParsingNotification"

@interface SearchWithDifferentCostFunctionsViewController ()

@end

@implementation SearchWithDifferentCostFunctionsViewController {
	NSArray *_mazes;
}
